# Archived snapshot of the GITT pulse-discharge protocol: this was the
# repo-root simulate_batteries.py until continuous discharge (closer to
# how Stena actually tests cells) was promoted to root in its place.
# Still used by experiments/01_.../soc_sweep.py and
# experiments/04_.../sweep_pulse_variable_discharge.py, which explicitly
# depend on the pulse protocol -- kept here, working, rather than deleted.
import os
import pybamm
import pandas as pd
import numpy as np
